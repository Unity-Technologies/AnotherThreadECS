...
// e.g. ffmpeg -r 60 -i "./movie_work/20180811_%04d.png" -vcodec mpeg4 -b:v 18000k out.mov
//      ffmpeg -r 60 -i "./movie_work/20180820_%04d.png" -pix_fmt yuv420p out.mp4
...
public class Recorder : MonoBehaviour
{
    ...
    void Update ()
    {
        ...
        if (isRecording == true)
        {
            SystemManagerSystem.DisplayInfo = false;
            SystemManager.Instance.setDebugText("");
            TakeScreenShot();
        }
    }
