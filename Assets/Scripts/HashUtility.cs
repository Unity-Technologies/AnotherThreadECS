...
namespace UTJ {
    ...
    public struct GridHash
    {
        ...
        public static int Hash(ref float3 v, float cellSize)
        {
            return Hash(Quantize(ref v, cellSize));
        }

        public static int3 Quantize(ref float3 v, float cellSize)
        {
            return new int3(math.floor(v / cellSize));
        }
    
        public static int Hash(ref float2 v, float cellSize)
        {
            return Hash(Quantize(ref v, cellSize));
        }

        public static int2 Quantize(ref float2 v, float cellSize)
        {
